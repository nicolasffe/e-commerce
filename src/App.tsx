...
const sportsTickets: Card[] = [
  ...
  },
  {
    ...
    image:
      "https://images.pexels.com/photos/161820/american-football-football-player-tackle-sport-161820.jpeg",
  },
  {
    title: "NHL",
...
const highlight = nextConcerts[0]
                  ...
                  <div className="flex flex-col gap-3">
                    <div className="flex items-start justify-between gap-3">
                      ...
                      <div className="text-right">
                        ...
                        <p className="text-lg font-semibold text-slate-900">R$ 280</p>
                        <button className="mt-2 w-full rounded-full bg-gradient-to-r from-amber-500 to-amber-400 px-4 py-2 text-sm font-semibold text-slate-900 shadow-[0_12px_30px_-16px_rgba(245,158,11,0.9)] hover:brightness-105">
                          Comprar
                        </button>
                      </div>
                    </div>
        ...
        >
          ...
          <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-3">
            {visibleShows.map((card) => (
              <article
                key={card.title}
                className="group overflow-hidden rounded-2xl bg-white shadow-sm ring-1 ring-slate-200 transition hover:-translate-y-1 hover:shadow-md hover:ring-amber-200"
              >
                <div className="relative">
                  <img
                    src={card.image}
              ...
              <div className="relative overflow-hidden rounded-3xl bg-slate-900 text-white shadow-lg">
                ...
                <div className="relative flex h-full flex-col gap-3 p-6">
                  ...
                  <div className="mt-auto flex items-center justify-between">
                    ...
                    <button className="rounded-full bg-white px-4 py-2 text-xs font-semibold uppercase tracking-[0.15em] text-slate-900 hover:brightness-105">
                      Comprar
                    </button>
                  </div>
                </div>
              ...
              <div className="space-y-3">
                {visibleFestivals.map((card) => (
                  ...
                  >
                    ...
                    <button className="flex items-center gap-1 rounded-full bg-amber-50 px-3 py-1.5 text-[11px] font-semibold text-amber-800 ring-1 ring-amber-200 hover:bg-amber-100">
                      Detalhes
